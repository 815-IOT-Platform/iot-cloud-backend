package com.iot.common.redis.aspect;
...
import com.iot.common.redis.annotation.RedisCache;
...
public class RedisAspect
{
     ...
     */
    @Pointcut("@annotation(com.iot.common.redis.annotation.RedisCache)")
    public void redisCachePoint()
    {
    }

    @Pointcut("@annotation(com.iot.common.redis.annotation.RedisEvict)")
