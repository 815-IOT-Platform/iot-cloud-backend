package com.iot.common.zk.registry.zookeeper;
...
/**
 * Created by rongshuai on 2020/6/16 20:13
 * 基于Zookeeper的注册中心.
...
public final class ZookeeperRegistryCenter implements CoordinatorRegistryCenter {
    ...
    public void registerMq(final String app, final String host, final String producerGroup, final String consumerGroup, String namesrvAddr) {
        // 注册生产者
        //生产者 zookeeper节点路径
        final String producerRootPath = GlobalConstants.ZK_REGISTRY_PRODUCER_ROOT_PATH + GlobalConstants.Symbol.SLASH + app;
        //消费者 zookeeper节点路径
        final String consumerRootPath = GlobalConstants.ZK_REGISTRY_CONSUMER_ROOT_PATH + GlobalConstants.Symbol.SLASH + app;
        ...
        if (StringUtils.isNotEmpty(producerGroup)) {
            ...
            this.persistEphemeral(producerRootPath + GlobalConstants.Symbol.SLASH + host, DateUtil.now());
        }
        // 注册消费者
        if (StringUtils.isNotEmpty(consumerGroup)) {
            ...
            this.persistEphemeral(consumerRootPath + GlobalConstants.Symbol.SLASH + host, DateUtil.now());
        }
